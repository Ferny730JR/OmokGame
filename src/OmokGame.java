public class OmokGame {
    ...
    public boolean moveIsValid(String userInput) {
        ...
        if(move[0] > board.boardSize || move[1] > board.boardSize) {
            System.out.println("Enter a valid move!");
            return false;
        } else {
    ...
    public int[] stringToInt(String userInput) throws ArrayIndexOutOfBoundsException {
        ...
        return new int[]{Integer.parseInt(move[0], board.getBoardSize()+1),
                         Integer.parseInt(move[1], board.getBoardSize()+1)};
    }
}
